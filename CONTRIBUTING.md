# Contributing to Blocss-plugin.givebreakpoint
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/plugin.givebreakpoint
   # Navigate to the newly cloned directory
   cd plugin.givebreakpoint
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Blocss/plugin.givebreakpoint
   ```
